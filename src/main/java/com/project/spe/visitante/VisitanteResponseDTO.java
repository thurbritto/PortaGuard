...
public record VisitanteResponseDTO(String nome, Long id, Long CPF, String placaCarro, String data, String hora, String nomeEmpresa, String email, Long telefone, String situacao, String motivo, Long porteiro) {
